...
def run(args, job):
    ...
    ALC.MakePoissonClusters('block_i_ref', FracNecrotic, Necr_s, Necr_r, OutputFile=f'NecrElem_frac{FracNecrotic}_s{Necr_s}_r{Necr_r}.regele', randseed=args.randseed)
