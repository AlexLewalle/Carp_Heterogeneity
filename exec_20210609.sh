...
for Tref1 in  $(seq -f %.2f $Trefref -5 0) 
do
	simoutput="${OutputDir}/Tref${Tref1}"

	# bench --load-module ~/Carp/MyModels/TT2_Cai.so --plug-in LandHumanStress --numstim 1 --imp-par='CaiClamp=0,CaiSET=${pCa1}' --dt 0.01 --stim-curr 100 --bcl 1000

	./ALC_20210609.py --duration $duration --ID ${simoutput}  --EP TT2_Cai  --pCa 5.0 --Tref $Tref1 --Stress LandHumanStress  --fracnecrotic 0.00 --vd 0 --np 15
