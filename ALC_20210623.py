...
def parser():
    ...
    group.add_argument('--Guccione_necr_a',
                        type=float, default=1.0,
                        help='Guccione stiffness prefactor for "necrotic" region.')
...
def setupMechMat(args,wedgeTags,necrosisTags):
    ...
    necrosis = model.mechanics.GuccioneMaterial(necrosisTags, 'wedge',  kappa=1000., a=args.Guccione_necr_a )   # ##### Should this read necrosisTag ???
...
def setupStressParams(EP, Stress, active_imp, Tref):
    ...
    p += [f'Tref={Tref}'] # 0.0']      #for active_imp[1]     NECROTIC TISSUE
